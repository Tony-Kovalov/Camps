...
import '../widgets/top_navigation_button1.dart';
...
class _ScenePageState extends State<ScenePage> {
  ...
  List<String> getMorningTexts() {
    switch (widget.numOfDay) {
      ...
      case 3:
        if (topButtonsState[1]) {
          return Program3Data.day3RubricMorningTxt;
        } else {
          return Program3Data.day3ScenariyMorningTxt;
        }
      case 4:
        if (topButtonsState[1]) {
      ...
      case 5:
        if (topButtonsState[1]) {
          return Program3Data.day5RubricMorningTxt;
        } else {
          return Program3Data.day5ScenariyMorningTxt;
        }
      default:
        if (topButtonsState[1]) {
  ...
  List<String> getEveningTexts() {
    switch (widget.numOfDay) {
      ...
      case 3:
        if (topButtonsState[1]) {
          return Program3Data.day3RubricEveningTxt;
        } else {
          return Program3Data.day3ScenariyEveningTxt;
        }
      case 4:
        if (topButtonsState[1]) {
      ...
      case 5:
        if (topButtonsState[1]) {
          return Program3Data.day5RubricEveningTxt;
        } else {
          return Program3Data.day5ScenariyEveningTxt;
        }
      default:
        if (topButtonsState[1]) {
  ...
  List<String> getMorningImages() {
    switch (widget.numOfDay) {
      ...
      case 5:
        if (topButtonsState[1]) {
          return Program3Data.day5RubricMorningImg;
        } else {
          return []; // no images
        }
      default:
  ...
  List<String> getEveningImages() {
    switch (widget.numOfDay) {
      ...
      case 5:
        if (topButtonsState[1]) {
          return Program3Data.day5RubricEveningImg;
        } else {
          return []; // no images
        }
      default:
